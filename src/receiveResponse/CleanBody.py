...
# with open(r"D:/Office Algo8/TechM/test/KPL_RPA/base code/changes in code for production/json_testing/file127.html", "r", encoding='utf-8') as f:
#     body= f.read()
# soup = BeautifulSoup(body, 'html.parser')
# body_email_store = str(soup)
# # div_bs4 = soup.find_all('div', {"class":re.compile('signature$', re.IGNORECASE)})
# # print(body_email_store)
# print(clean_body_mail(body))
